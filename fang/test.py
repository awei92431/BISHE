...
CAMERA_TO_RING_CONNECTOR_OFFSET = np.array([0.0, 0.0, 0.016], dtype=float)
RING_TO_ENDOSCOPE_OFFSET = np.array([0.0, 0.0, 0.0030], dtype=float)
RING_CONNECTOR_CORE_SIZE = (0.0098, 0.0060, 0.0)
